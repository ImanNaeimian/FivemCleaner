...
@echo off
chcp 65001
title Made By: Rɇa!Victør
cls
echo.
echo.
echo [31m[] CREATED BY Rɇa!Victør[0m
timeout 2 >nul
echo.
echo    LOADING... 
echo    WAIT 3s..
...
mode 130,30
echo.
echo                                    				GiTHub : https://github.com/ImanNaeimian
echo.
echo.
echo                                    [31m[1][0m - [32mTX UNBAN/ EasyAdmin (Detected!) [0m               [31m[2][0m - [32mUsefull Cleaners[0m
echo.
echo.
...
echo.
echo.
echo                             [31m9[0m - [32mSPOOFER(NOT WORKING !)[0m                 [31m10[0m - [32mUNLINK DISCORD[0m                        
echo.
echo.
echo.
set /p key=key : 
